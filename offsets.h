...
namespace offsets
{
    ...
    constexpr auto dwEntityList = 0x4DBF73C;
    constexpr auto dwForceAttack = 0x31EFCB4;
    constexpr auto dwForceAttack2 = 0x31EFCC0;
    constexpr auto dwForceBackward = 0x31EFC6C;
    constexpr auto dwForceForward = 0x31EFC78;
    constexpr auto dwForceJump = 0x5269550;
    constexpr auto dwForceLeft = 0x31EFC90;
    constexpr auto dwForceRight = 0x31EFC84;
    constexpr auto dwGameDir = 0x627700;
    constexpr auto dwGameRulesProxy = 0x52DC82C;
    constexpr auto dwGetAllClasses = 0xDCDA94;
    constexpr auto dwGlobalVars = 0x588CF0;
    constexpr auto dwGlowObjectManager = 0x5307C30;
    constexpr auto dwInput = 0x5210D00;
    constexpr auto dwInterfaceLinkList = 0x956BF4;
    constexpr auto dwLocalPlayer = 0xDA545C;
    constexpr auto dwMouseEnable = 0xDAAFA8;
    constexpr auto dwMouseEnablePtr = 0xDAAF78;
    constexpr auto dwPlayerResource = 0x31EDFE0;
    constexpr auto dwRadarBase = 0x51F44B4;
    constexpr auto dwSensitivity = 0xDAAE44;
    constexpr auto dwSensitivityPtr = 0xDAAE18;
    constexpr auto dwSetClanTag = 0x8A130;
    constexpr auto dwViewMatrix = 0x4DB1054;
    constexpr auto dwWeaponTable = 0x52117C4;
    constexpr auto dwWeaponTableIndex = 0x326C;
    constexpr auto dwYawPtr = 0xDAAC08;
    constexpr auto dwZoomSensitivityRatioPtr = 0xDAFEA8;
    constexpr auto dwbSendPackets = 0xD7BD2;
    constexpr auto dwppDirect3DDevice9 = 0xA7050;
    constexpr auto find_hud_element = 0x2D862EA0;
    constexpr auto force_update_spectator_glow = 0x3B3EFA;
    constexpr auto interface_engine_cvar = 0x3E9EC;
    constexpr auto is_c4_owner = 0x3C0E50;
    constexpr auto m_bDormant = 0xED;
    constexpr auto m_flSpawnTime = 0x103C0;
    constexpr auto m_pStudioHdr = 0x2950;
    constexpr auto m_pitchClassPtr = 0x51F4750;
    constexpr auto m_yawClassPtr = 0xDAAC08;
    constexpr auto model_ambient_min = 0x58C00C;
    constexpr auto set_abs_angles = 0x1E3D90;
    constexpr auto set_abs_origin = 0x1E3BD0;
}