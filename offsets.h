...
namespace offsets
{
    ...
    constexpr auto m_ArmorValue = 0x113CC;
    ...
    constexpr auto m_angEyeAnglesX = 0x113D0;
    constexpr auto m_angEyeAnglesY = 0x113D4;
    ...
    constexpr auto m_bHasDefuser = 0x113DC;
    constexpr auto m_bHasHelmet = 0x113C0;
    ...
    constexpr auto m_iCrosshairId = 0x11438;
    ...
    constexpr auto dwEntityList = 0x4DBC5B4;
    constexpr auto dwForceAttack = 0x31ECB34;
    constexpr auto dwForceAttack2 = 0x31ECB40;
    constexpr auto dwForceBackward = 0x31ECAEC;
    constexpr auto dwForceForward = 0x31ECAF8;
    constexpr auto dwForceJump = 0x52663C4;
    constexpr auto dwForceLeft = 0x31ECB10;
    constexpr auto dwForceRight = 0x31ECB04;
    constexpr auto dwGameDir = 0x627700;
    constexpr auto dwGameRulesProxy = 0x52D96AC;
    constexpr auto dwGetAllClasses = 0xDCAA5C;
    constexpr auto dwGlobalVars = 0x588CF0;
    constexpr auto dwGlowObjectManager = 0x5304AC0;
    constexpr auto dwInput = 0x520DB78;
    constexpr auto dwInterfaceLinkList = 0x9538B4;
    constexpr auto dwLocalPlayer = 0xDA244C;
    constexpr auto dwMouseEnable = 0xDA7F98;
    constexpr auto dwMouseEnablePtr = 0xDA7F68;
    constexpr auto dwPlayerResource = 0x31EAE60;
    constexpr auto dwRadarBase = 0x51F132C;
    constexpr auto dwSensitivity = 0xDA7E34;
    constexpr auto dwSensitivityPtr = 0xDA7E08;
    constexpr auto dwSetClanTag = 0x8A130;
    constexpr auto dwViewMatrix = 0x4DADEB4;
    constexpr auto dwWeaponTable = 0x520E63C;
    constexpr auto dwWeaponTableIndex = 0x326C;
    constexpr auto dwYawPtr = 0xDA7BF8;
    constexpr auto dwZoomSensitivityRatioPtr = 0xDACE98;
    constexpr auto dwbSendPackets = 0xD7A62;
    constexpr auto dwppDirect3DDevice9 = 0xA7050;
    constexpr auto find_hud_element = 0x5CAE27A0;
    constexpr auto force_update_spectator_glow = 0x3B38CA;
    constexpr auto interface_engine_cvar = 0x3E9EC;
    constexpr auto is_c4_owner = 0x3C0820;
    constexpr auto m_bDormant = 0xED;
    constexpr auto m_flSpawnTime = 0x103C0;
    constexpr auto m_pStudioHdr = 0x2950;
    constexpr auto m_pitchClassPtr = 0x51F15C8;
    constexpr auto m_yawClassPtr = 0xDA7BF8;
    constexpr auto model_ambient_min = 0x58C00C;
    constexpr auto set_abs_angles = 0x1E37C0;
    constexpr auto set_abs_origin = 0x1E3600;
}